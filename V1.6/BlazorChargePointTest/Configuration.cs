...
namespace BlazorChargePointTest
{
    ...
    {
        public bool ShowingChoiceDialog { get; set; }
        public IAction Action { get; set; }
        public OcppMessage OcppMessage { get; set; }
        public string UserMessage { get; set; }

        public List<KeyValue> Core { get; set; } = new();
        public List<KeyValue> ListManagement { get; set; } = new();
        public  List<KeyValue> Reservation { get; set; } = new();
        public  List<KeyValue> SmartCharging { get; set; } = new();
        ...
        public static void SetSettingsValue<T>(string name, T value)
        {
            KeyValue setting = Settings.First(s => s.Name.Equals(name));
